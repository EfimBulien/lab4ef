...
namespace laba2ef
{
    public partial class DriversEditorWindow : Window
    {
        ...
        public DriversEditorWindow()
        {
            ...
            CarsBox.ItemsSource = lab1Entities.cars.ToList();
        }
        ...
        private void CarsBox_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            {
                var selected = CarsBox.SelectedItem as cars;
                DriversDataGrid.ItemsSource = lab1Entities.drivers.ToList().Where(item => item.cars== selected);
            }
        }
